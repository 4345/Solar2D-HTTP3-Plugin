...
createButton(display.contentCenterX, 570, 330, 34, "Инфо о нативном стеке", {0.4, 0.3, 0.6}, function()
    ...
    logMessage("Сборка плагина: " .. tostring(stats.buildTimestamp or "Неизвестно"))
...
updateUI()
local initStats = http3.getMemoryStats()
logMessage("Тестовое приложение запущенно.")
logMessage("[ВЕРСИЯ ПЛАГИНА] Дата компиляции: " .. tostring(initStats.buildTimestamp or "N/A"))
